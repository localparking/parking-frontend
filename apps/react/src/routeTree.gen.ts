...
const OnboardingFinalOnboardingPageRoute = OnboardingFinalOnboardingPageImport.update({
...
const MapLayoutRouteWithChildren = MapLayoutRoute._addFileChildren(MapLayoutRouteChildren)
