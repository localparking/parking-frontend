...
// import { isMapReady } from '../hooks/use-map'
...
//             isMapReady ? 'bg-blue-600 hover:bg-blue-700 active:scale-95 active:bg-blue-800' : 'bg-gray-400 opacity-50'
//           }`}
//         >
//           서울시청 이동
//         </button>
...
//           disabled={!isMapReady}
//           className={`text-body-03 rounded-md border-none px-3 py-2 font-medium text-white shadow-lg transition-all duration-200 ${
//             isMapReady ? 'bg-red-500 hover:bg-red-600 active:scale-95 active:bg-red-700' : 'bg-gray-400 opacity-50'
//           }`}
//         >
//           마커 모두 삭제
//         </button>
...
//           isMapReady ? 'bg-blue-500 hover:bg-blue-600 active:scale-90 active:bg-blue-700' : 'bg-gray-400 opacity-50'
//         }`}
//       >
//         📍
//       </button> */}
